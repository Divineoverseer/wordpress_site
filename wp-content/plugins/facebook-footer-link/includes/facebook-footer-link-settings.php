    ...
    ob_start(); ?>
        <div class="wrap">
            ...
            <form method="post" action="options.php">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input name="ffl_settings[link_color]" type="text" id="ffl_settings[link_color]" value="<?php echo $ffl_options['link_color']; ?>" class="regular-text">
                                <p class="description"><?php _e('Enter your Enter a color or HEX value with #', 'ffl_domain'); ?></p></td>
                        </tr>
                        <tr>
                ...
                <p class="submit"><input type="submit" name="submit" class="button button-primary" value="<?php _e('Save Changes', 'ffl_domain'); ?>" </p>
            </form>
        </div>
    <?php
    echo ob_get_clean();
